...
<div class="top_page">
    ...
    <div class="top_menu right">
        <ul>
            <li><a href="disenio_web.php">Dise&ntilde;o Web</a><span class="hover<?php if( $pagename=="disenio_web.php" ) echo " current";?>"></span></li>
            <li><a href="disenio_grafico.php">Dise&ntilde;o Grafico</a><span class="hover<?php if( $pagename=="disenio_grafico.php" ) echo " current";?>"></span></li>
            <li><a href="marketing_online.php">Marketing On-line</a><span class="hover<?php if( $pagename=="marketing_online.php" ) echo " current";?>"></span></li>
            <li><a href="portfolio.php">Portfolio</a><span class="hover<?php if( $pagename=="portfolio.php" ) echo " current";?>"></span></li>
            <li><a href="/blog">Blog</a><span class="hover"></span></li>
            <li><a href="contactenos.php">Cont&aacute;ctenos</a><span class="hover<?php if( $pagename=="contactenos.php" ) echo " current";?>"></span></li>
        </ul>
    </div>
</div>
