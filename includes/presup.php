...
try {
    ...
    $message_html.= '<h3>'. $_POST["typeproyect"] .'</h3>';
    ...
    if( $_POST["option"]=="marketing" ){
        $message_html.= '<b>Población Objetivos:&nbsp;</b><span>'. $_POST["cboPoblacion"] .'</span><br>';
        if( $_POST["cboTask"]=="E-Mail Marketing" ){
            $message_html.= '<b>Presupuestar Diseño Newsletter:&nbsp;</b><span>'. get_result("chk13") .'</span><br>';
            $message_html.= '<b>Presupuestar Base de Datos de mails:&nbsp;</b><span>'. get_result("chk14") .'</span><br>';
        }
    }

    if( $_POST["option"]=="dweb" ){
