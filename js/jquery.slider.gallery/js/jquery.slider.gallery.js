...
var ClassSliderGallery = function(options){
    ...
    this.next = function(){
        ...
        if( index <= data.countPage ){
            ...
            }, options.speed, function(){working=false;});
        }else{
            index=1;
            data.thumbContainer.stop()
                               .animate({ left : '+=50' }, 550, function(){working=false;})
                               .animate({ left : '0' }, 800, function(){working=false;});
        }
    ...
    this.prev = function(){
        ...
        if( index > 1 ){
            ...
            data.thumbContainer.stop()
                               .animate({ left : '+=50' }, 550, function(){working=false;})
                               .animate({ left : '-='+(data.countPage*data.thumbWidth+50) }, 800, function(){working=false;});
        }
    ...
    var init = function(){
        ...
        if( options.autoplay ) temp = setInterval(This.next, options.interval);
